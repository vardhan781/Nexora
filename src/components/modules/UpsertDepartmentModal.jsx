...
import { Building, Hash, FileText } from "lucide-react";

export const UpsertDepartmentModal = ({
  open,
  onCancel,
  onSubmit,
  departmentData,
  ...
  }, [open, isEditMode, departmentData]);
  ...
  return (
    <Modal
      ...
      confirmText={isEditMode ? "Save Changes" : "Create Department"}
      size="xl"
    >
