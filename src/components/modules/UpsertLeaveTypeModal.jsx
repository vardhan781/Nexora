...
export const UpsertLeaveTypeModal = ({
  open,
  onCancel,
  onSubmit,
  leaveTypeData,
  ...
  const isEditMode = !!leaveTypeData;
  ...
  return (
    <Modal
      ...
      confirmText={isEditMode ? "Save Changes" : "Create Leave Type"}
      size="xl"
    >
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input
            ...
            required={true}
            maxLength={50}
            requiredMessage="Leave type name is required"
